...
export default defineManifest({
  ...
  version: '0.6.0',
  description:
    'Self-hosted, zero-knowledge password manager with one-click autofill (auto-fills the best saved match, no picker needed), a matching key icon on both username and password fields, a redesigned category-rail app window (websites, authenticator codes, passkeys, favorites), password generator, authoritative passkey (WebAuthn) support, and multi-language save-prompt detection for modern sign-in/sign-up forms.',
  action: {
